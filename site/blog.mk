...
_.html: _.md _.id _.title _.date _.cat ../../_.sitetitle ../../_.siteurl ../../_.author ../../post.temp.htm ../../disqus.seg.htm ../../ga.seg.htm
	...
	pandoc --mathjax $$([ -f _.toc ] && echo --toc) --template=../../post.temp.htm -A ../../disqus.seg.htm -A ../../ga.seg.htm -V id=$$(< _.id) -V "title=$$(< _.title)" -V date=$$(< _.date) -V cat=$$(< _.cat) -V "sitetitle=$$(< ../../_.sitetitle)" -V "siteurl=$$(< ../../_.siteurl)" -V "author=$$(< ../../_.author)" --css=../../root.css -o $@ $<

_.htm: _.md _.id ../../content.temp.htm
	echo PANDOC HTM $$(< _.id)
	pandoc --mathjax $$([ -f _.toc ] && echo --toc) --template=../../content.temp.htm -o $@ $<
