...
_.html: _.md _.id _.title _.date _.cat ../../_.sitetitle ../../_.siteurl ../../_.author ../../post.temp.htm ../../disqus.seg.htm ../../ga.seg.htm
	...
	pandoc -t html5 --mathjax="https://cdn.bootcss.com/mathjax/2.6.1/MathJax.js?config=TeX-AMS-MML_HTMLorMML" $$([ -f _.toc ] && echo --toc) --template=../../post.temp.htm -H ../../myhead.seg.htm -A ../../disqus.seg.htm -A ../../ga.seg.htm --highlight-style=kate -V id=$$(< _.id) -V "title=$$(< _.title)" -V date=$$(< _.date) -V cat=$$(< _.cat) -V "sitetitle=$$(< ../../_.sitetitle)" -V "siteurl=$$(< ../../_.siteurl)" -V "author=$$(< ../../_.author)" --css=../../root.css -o $@ $<
